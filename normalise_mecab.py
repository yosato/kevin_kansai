...
def main0(LexFPs,MecabCorpusFPs,CorpusOnly=False,FreqWdFP=None,UnnormalisableMarkP=True,ProbExemplarFP=None):
    ...
    Frequents=collect_freq_wds(FreqWdFP,2000) if FreqWdFP else set()
...
def collect_freq_wds(FreqWdFP,RankUpTo):
    Wds=set()
